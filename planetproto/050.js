...
//    an empty object `{}`
var machine = {
  parts: [], // this property is shared between all objects, you can use constructor to make it unique, see lab 100.js
  capabilities: {} // this property is shared between all objects, you can use constructor to make it unique, see lab 100.js
};
var robot = {};
var vehicle = {};
